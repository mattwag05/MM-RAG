...
As of 2026-06-02 UTC / 2026-06-01 EDT, MM-RAG is deployed on `homelab-host` from
...
that fix must be pulled/rebuilt/restarted on homelab-host before it changes the
live service behavior. See `docs/homelab-host-burn-in.md` for the full burn-in
reference.
