...
.PHONY: help sync sync-dev sync-m3 test lint format clean init-db serve-api serve-mcp serve-mcp-http check-pironman-mcp worker docker-build docker-up docker-pi-config docker-pi-up docker-pi-down docker-pi-logs
...
help:
	...
	@echo "  make check-pironman-mcp # validate live Pironman MCP + Hermes"
